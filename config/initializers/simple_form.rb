...
SimpleForm.setup do |config|
  ...
  config.wrappers :semantic_radio_checkbox, tag: 'div', class: "inline fields", error_class: 'error', hint_class: 'with_hint' do |b|
    b.use :html5
    b.wrapper tag: 'div', class: 'field' do |field|
      field.wrapper tag: 'div', class: 'ui radio checkbox' do |input|
        input.use :input
        input.wrapper tag: 'label' do |radio| end
      end
    end
  end
